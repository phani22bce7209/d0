  ...
  return (
    <div>
      ...
      <div style={{ width: "100%", minHeight: "100vh", display: "flex", flexWrap:"wrap" }}>
        <div className='lgnd1' style={{ height: "100vh", width: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
          <div className='lgnd1' style={{ height: "auto", width: "50%", backgroundColor: "transparent", textAlign: "center", borderRadius: "50px" }}>
            <h1>Login</h1><br /><br />
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", marginLeft: "5%", height: "70px", justifyContent: "space-evenly" }}>
              ...
              <input onChange={(e) => setEmail(e.target.value)} style={{ width: "90%", height: 35, border: validator === true&email==="" ? "1px solid red" : "1px solid #0a98e2" }} />
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", marginLeft: "5%", height: "70px", justifyContent: "space-evenly", }}>
              ...
              <input type="Password" onChange={(e) => setPassword(e.target.value)} style={{ width: "90%", height: 35, border: validator === true&password==="" ? "1px solid red" : "1px solid #0a98e2" }} />
            </div>
            <br />  <br />
            <div style={{ display: "flex", justifyContent: "start", paddingLeft: "5%" }} ><button onClick={() => logincheck()} style={{ height: "40px", width: "150px", backgroundColor: "#9edc57", borderRadius: 10, border: "none", color: "white" }}>Sign In</button></div>
            <br /><br /><br /><br />
