                            ...
                            <div style={{ width: "95%", minHeight: "10vh", backgroundColor: "white", display: "flex", borderRadius: 10, paddingTop: "10px", flexDirection: "column", overflowY: "auto", }}>
                                <div className='set-res1'   style={{ minHeight: "4vh", width: "100%", display: "flex", }}>
                                    <div className='lgnd1'  style={{ width: "30%", height: "40vh", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                        <button onClick={() => setShow(1)} style={{ height: "40px", width: "80%", backgroundColor: "#9edc57", color: "white", border: "none", borderRadius: 10, marginLeft: "2%" }}>Change Name</button>
                                    ...
                                    <div className='lgnd1'  style={{ width: "30%", height: "40vh", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                        <button onClick={() => setShow(2)} style={{ height: "40px", width: "80%", backgroundColor: "#9edc57", color: "white", border: "none", borderRadius: 10, marginLeft: "2%" }}>Change Password</button>
                                    ...
                                    <div className='lgnd1'  style={{ width: "30%", height: "40vh", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                        <button onClick={() => setShow(3)} style={{ height: "40px", width: "80%", backgroundColor: "#9edc57", color: "white", border: "none", borderRadius: 10, marginLeft: "2%" }}>Change Email</button>
                                    ...
                                    {type === "teacher" ?
                                        <div className='lgnd1'  style={{ width: "30%", height: "40vh", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                            <button onClick={() => setShow(4)} style={{ height: "40px", width: "80%", backgroundColor: "#9edc57", color: "white", border: "none", borderRadius: 10, marginLeft: "2%" }}>Add  Sedule Timing</button>
                                    ...
                                    {type === "teacher" ?
                                        <div className='lgnd1'  style={{ width: "30%", height: "40vh", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                            <button onClick={() => setShow(5)} style={{ height: "40px", width: "80%", backgroundColor: "#9edc57", color: "white", border: "none", borderRadius: 10, marginLeft: "2%" }}>Add Class Link</button>
